...
class Poll extends Component {
    ...
    getTimeRemaining = (poll) => {
        ...
        if(days > 0) {
            timeRemaining = days + " dias restantes";
        } else if (hours > 0) {
            timeRemaining = hours + " horas restantes";
        } else if (minutes > 0) {
            timeRemaining = minutes + " minutos restantes";
        } else if(seconds > 0) {
            timeRemaining = seconds + " segundos restantes";
        } else {
            timeRemaining = "menos de un segundo restante";
        }
            ...
            <div className="poll-content">
                ...
                <div className="poll-footer">
                    { 
                        ...
                        (<Button className="vote-button" disabled={!this.props.currentVote} onClick={this.props.handleVoteSubmit}>Votar</Button>) : null 
                    }
                    <span className="total-votes">{this.props.poll.totalVotes} votos</span>
